...
const steps = [
  {
    ...
    description:
      "Delivering pixel-perfect, smooth, and immersive interfaces—where design meets performance",
  },
  {
    id: "2",
    name: "Step 2",
    ...
    description:
      "Bringing ideas to life with elegant animations, clean architecture, and delightful user interactions",
  },
  {
    id: "3",
    name: "Step 3",
    ...
    description:
      "From concept to polished product—turning vision into intuitive experiences users love",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Modern Web, Done Right",
    description:
      "Fast, responsive, optimized, and future-ready interfaces built with precision and creativity",
  },
] as const;
