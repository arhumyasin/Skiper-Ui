...
export default function ThemeToggleButton({
  ...
  return (
    ...
    >
      <SunIcon className="size-[2.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
      <MoonIcon className="absolute size-[2.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
